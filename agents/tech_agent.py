"""
Technology specialist agent — analyzes product, R&D, and innovation disclosures.
"""

from anthropic import Anthropic

from agents.state import AgentState
from agents.prompts.tech import TECH_SYSTEM, TECH_FEW_SHOTS
...
def tech_agent_node(state: AgentState) -> dict:
    """LangGraph node for technology analysis."""
